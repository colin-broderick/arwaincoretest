 ...
 */
Timers::ScopedTimer::ScopedTimer(const std::string& name) : ScopedTimer(name, std::cout)
{
}
...
*/
Timers::ScopedTimer::ScopedTimer(const std::string& name, std::ostream& out_stream)
{
    _name = name;
...
Timers::ScopedTimer::~ScopedTimer()
{
 ...
 */
Timers::CountdownTimer::CountdownTimer(const int timer_duration_ms)
{
