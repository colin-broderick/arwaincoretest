...
{
    acce_roller = new arwain::RollingAverage{ag_window_size_};
    gyro_roller = new arwain::RollingAverage{ag_window_size_};
    velo_roller = new arwain::RollingAverage{velo_window_size_};
}
