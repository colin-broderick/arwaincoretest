...
{
    double roll = std::atan2(w*x + y*z, 0.5f - x*x - y*y);
	double pitch = std::asin(-2.0f * (x*z - w*y));
	double yaw = std::atan2(x*y + w*z, 0.5f - y*y - z*z);
...
{
    double roll = std::atan2(w*x + y*z, 0.5f - x*x - y*y)*180.0/3.14159;
	double pitch = std::asin(-2.0f * (x*z - w*y))*180.0/3.14159;
	double yaw = std::atan2(x*y + w*z, 0.5f - y*y - z*z)*180.0/3.14159;
