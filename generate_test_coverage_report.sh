#!/bin/bash
mkdir ./test_report
lcov --capture --directory ./CMakeFiles/arwain_test.dir/src/ --directory ./CMakeFiles/arwain_test.dir/quaternion/ --directory ./CMakeFiles/arwain_test.dir/logger/ --output-file=coverage.info
