...
extern int bmi_file_i2c;
extern struct bmi2_dev bmi270;
extern struct bmm150_dev bmm150;
extern vector3 mag_calib_offset, mag_calib_scale;
...
int BMI270::init_bmi270(int mag_enabled, std::string calib_file)
{
    float g = 9.8067;
...
int BMI270::get_bmm150_data(struct vector3 *mag)
{
    int rslt;
...
int BMI270::get_bmi270_data(struct vector3 *acc, struct vector3 *gyr)
{
    int rslt;
