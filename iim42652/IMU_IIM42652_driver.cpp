...
void set_gyro_bias(double, double, double) {}

void set_accel_bias(double, double, double) {}

void set_accel_scale(double, double, double) {}

void set_correction_speed(double) {}

void enable_auto_calib() {}

void enable_auto_calib(double) {}
...
double get_gyro_calib_x() { return 0; }
double get_gyro_calib_y() { return 0; }
double get_gyro_calib_z() { return 0; }
